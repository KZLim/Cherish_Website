                ...
                <div class="row">
                    <div class="col-4 text-center col-height" style="border-right: 1px solid #ffa9a3; width:390px; word-wrap: break-word;">
                        <?php                            
                            ...
                            $query = "SELECT * FROM ngo_profile WHERE ouid= ?";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo'<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button class="nav-link" id="change-address-tab" data-bs-toggle="pill" data-bs-target="#change-address-pill" type="button" role="tab">Change Address</button>
                                    </div>';
        ...
        <?php
            if(!empty($_GET['actionCondition'])){
                ...
                if($alertCondition == "emailModifiedTrue"){
                    ...
                    echo"<script>
                            alertify.alert('Account Action','Address Changed Successfully!');
                        </script>";
                }
                    ...
                    echo"<script>
                            alertify.alert('Account Action','Banner Changed Successfully!');
                        </script>";
                }
                    ...
                    echo"<script>
                            alertify.alert('Account Action','Website URL Changed Successfully!');
                        </script>";
                }
                else if($alertCondition == "pppempty"){
                    echo"<script>
                        alertify.alert('Account Action','No profile picture provided, please provide a file.');
                    </script>";
                }
                else if($alertCondition == "bpempty"){
                    echo"<script>
                        alertify.alert('Account Action','No banner picture provided, please provide a file.');
                    </script>";
                }
                else if($alertCondition == "bioempty"){
                    echo"<script>
                        alertify.alert('Account Action','Cannot update empty bio, write something!');
                    </script>";
                }
                else if($alertCondition == "anperr"){
                    echo"<script>
                        alertify.alert('Account Action','Something went wrong while performing the action. Please try again.');
                    </script>";
                }
                else if($alertCondition == "anp"){
                    echo"<script>
                        alertify.alert('Account Action','Unable to Change Password. Try Again.');
                    </script>";
                }
            }
