...
<html>
<head>
    <title>Donors Age | Overall</title>
...
<div class="container text-center">
    <div class="row">
        <div class="col-12 col-md-6">
            <div style="width: 100%; max-width: 400px; height: 400px;">
                <canvas id="overallAgeGroup_campaign"></canvas>
            </div>
        </div>
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center">
            <h4>Your NGO's Overall Campaign Donor's Age Group</h4>
            <table class="table">
                <thead>
                    <tr>
    ...
    <script>
        ...
        var ngoOverallAgeGroup_campaign = document.getElementById('overallAgeGroup_campaign').getContext('2d');

        var ageGroup_campaign = {
        ...
        var ageGroupdata_campaign= {
            labels: ['1-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-99'],
            datasets: [{
                data: [ageGroup_campaign["1-10"],ageGroup_campaign["11-20"],ageGroup_campaign["21-30"],ageGroup_campaign["31-40"],
                        ageGroup_campaign["41-50"],ageGroup_campaign["51-60"],ageGroup_campaign["61-70"], ageGroup_campaign["71-80"],
                        ageGroup_campaign["81-90"],ageGroup_campaign["91-99"]], // Values for each slice
                backgroundColor: ['blue', 'pink', 'red', 'green', 'orange', 'purple', 'cyan', 'magenta', 'yellow', 'lightblue'], // Colors for each slice
            }]
        };

        // Create a pie chart
        var overallAgeGroup_campaign = new Chart(ngoOverallAgeGroup_campaign, {
            type: 'pie',
            data: ageGroupdata_campaign
        });
    </script>
</body>
</html>
