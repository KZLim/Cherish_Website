...
<html>
<head>
    <title>Participant Age | Overall</title>
...
<body>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div style="width: 100%; max-width: 400px; height: 400px;">
                    <canvas id="overallAgeGroup_activity"></canvas>
                </div>
            </div>
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center">
                <h4>Your NGO's Overall Activity Participant's Age Group</h4>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $ageGroup3; ?></td>
                        </tr>
                        <tr>
                            <th scope="row">Age "31-40"</th>
                            <td><?php echo $ageGroup4; ?></td>
                        </tr>
                        <tr>
                            <th scope="row">Age "41-50"</th>
                            <td><?php echo $ageGroup5; ?></td>
                        </tr>
                        <tr>
                            <th scope="row">Age "51-60"</th>
                            <td><?php echo $ageGroup6; ?></td>
                        </tr>
                        <tr>
                            <th scope="row">Age "61-70"</th>
                            <td><?php echo $ageGroup7; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo $ageGroup9; ?></td>
                        </tr>
                        <tr>
                            <th scope="row">Age "91-99"</th>
                            <td><?php echo $ageGroup10; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <script>
        ...
        var ngoOverallAgeGroup_activity = document.getElementById('overallAgeGroup_activity').getContext('2d');

        var ageGroup_activity = {
        ...
        var ageGroupdata_activity= {
            labels: ['1-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-99'],
            datasets: [{
                data: [ageGroup_activity["1-10"],ageGroup_activity["11-20"],ageGroup_activity["21-30"],ageGroup_activity["31-40"],
                        ageGroup_activity["41-50"],ageGroup_activity["51-60"],ageGroup_activity["61-70"], ageGroup_activity["71-80"],
                        ageGroup_activity["81-90"],ageGroup_activity["91-99"]], // Values for each slice
                backgroundColor: ['blue', 'pink', 'red', 'green', 'orange', 'purple', 'cyan', 'magenta', 'yellow', 'lightblue'], // Colors for each slice
            }]
        };

        // Create a pie chart
        var overallAgeGroup_activity = new Chart(ngoOverallAgeGroup_activity, {
            type: 'pie',
            data: ageGroupdata_activity
        });
    </script>
</body>
</html>
