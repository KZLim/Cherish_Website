...
<html>
<head>
    <title>Participant Gender | Specific</title>
...
<body>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div style="width: 100%; max-width: 400px; height: 400px;">
                    <canvas id="specificGender_activity"></canvas>
                </div>
            </div>
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center">
                <h4>Overall Activity Participant Based on Gender</h4>
                <table class="table">
                    <thead>
                        <tr>
    ...
    <script>
        ...
        var ngoSpecificGender_activity = document.getElementById('specificGender_activity').getContext('2d');

        var genderSpecific_activity = {
            male: <?php echo $overallMale_basedActivity; ?>,
            female: <?php echo $overallFemale_basedActivity; ?>
        };

        // Data for the pie chart
        var genderDataSpecific_activity = {
            labels: ['Male', 'Female'],
            datasets: [{
                data: [genderSpecific_activity.male,genderSpecific_activity.female], // Values for each slice
                backgroundColor: ['blue', 'pink'], // Colors for each slice
            }]
        };

        // Create a pie chart
        var specificGender_activity = new Chart(ngoSpecificGender_activity, {
            type: 'pie',
            data: genderDataSpecific_activity
        });
    </script>
</body>
</html>
