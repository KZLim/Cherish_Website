...
<html>
<head>
    <title>Participant Location | Specific</title>
...
<body>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div style="width: 100%; max-width: 400px; height: 400px;">
                    <canvas id="specificLocation_activity"></canvas>
                </div>
            </div>
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center">
                <h4>Overall Activity Participant's Location</h4>
                <table class="table">
                    <thead>
                        <tr>
    ...
    <script>
        ...
        var ngoSpecificLocation_activity = document.getElementById('specificLocation_activity').getContext('2d');

        var locationGroupSpecific_activity = {
        ...
        var locationGroupDataSpecific_activity= {
            ...
            datasets: [{
                data: [locationGroupSpecific_activity["Perlis"],locationGroupSpecific_activity["Kedah"],locationGroupSpecific_activity["Pulau Pinang"],locationGroupSpecific_activity["Perak"],
        ...
        // Create a pie chart
        var specificLocation_activity = new Chart(ngoSpecificLocation_activity, {
            type: 'pie',
            data: locationGroupDataSpecific_activity
        });
    </script>
</body>
</html>
