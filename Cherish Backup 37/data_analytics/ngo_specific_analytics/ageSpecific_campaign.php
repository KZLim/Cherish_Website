...
<html>
<head>
    <title>Donors Age | Specific</title>
...
<body>
        ...
        <div class="row">
            <div class="col">
                <div style="width: 400px; height: 400px;">
                    <canvas id="specificAgeGroup_campaign"></canvas>
                </div>
            </div>
            <div class="col d-flex flex-column justify-content-center align-items-center">
                <h4>This Campaign Donor's Age Group</h4>
                <table class="table">
                    <thead>
                        <tr>
    ...
    <script>
        ...
        var ngoSpecificAgeGroup_campaign = document.getElementById('specificAgeGroup_campaign').getContext('2d');

        var ageGroupSpecific_campaign = {
        ...
        var ageGroupdataSpecific_campaign= {
            labels: ['1-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-99'],
            datasets: [{
                data: [ageGroupSpecific_campaign["1-10"],ageGroupSpecific_campaign["11-20"],ageGroupSpecific_campaign["21-30"],ageGroupSpecific_campaign["31-40"],
                        ageGroupSpecific_campaign["41-50"],ageGroupSpecific_campaign["51-60"],ageGroupSpecific_campaign["61-70"], ageGroupSpecific_campaign["71-80"],
                        ageGroupSpecific_campaign["81-90"],ageGroupSpecific_campaign["91-99"]], // Values for each slice
                backgroundColor: ['blue', 'pink', 'red', 'green', 'orange', 'purple', 'cyan', 'magenta', 'yellow', 'lightblue'], // Colors for each slice
            }]
        };

        // Create a pie chart
        var specificAgeGroup_campaign = new Chart(ngoSpecificAgeGroup_campaign, {
            type: 'pie',
            data: ageGroupdataSpecific_campaign
        });
    </script>
</body>
</html>
