                ...
                if(!empty($_SESSION['identifier']) && (substr($_SESSION['identifier'],0,3))=="CAG"){
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="adminCanvas" aria-labelledby="adminCanvas">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="mt-3">
                                <a class="admin-hamburger-menu" href="../admin/ngoManagement.php">NGO Management</a><br/>
                                <a class="admin-hamburger-menu" href="../admin/userManagement.php">User Management</a><br/>
                                <a class="admin-hamburger-menu" href="../admin/campaignManagement.php">Campaign Management</a><br/>
                                <a class="admin-hamburger-menu" href="../admin/activityManagement.php">Activity Management</a><br/>
                                <a class="admin-hamburger-menu" href="../admin/dataReveal.php">Data Reveal Management</a><br/>
