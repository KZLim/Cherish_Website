                    ...
                    <a href="ngoListing.php?category=Animal Welfare">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Champions of Animal Welfare. Support those who protect and care for our furry friends!</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="ngoListing.php?category=Children Welfare">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Empowering Future Generations. NGOs committed to the well-being and rights of children.</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="ngoListing.php?category=Education Support">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Illuminating Minds. Organizations dedicated to fostering education and knowledge.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col d-flex justify-content-center card-col-view" >
                    <a href="ngoListing.php?category=Healthcare">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                <h6>Healthcare</h6>
                                <p class="card-text">Healing Hands. Supporting healthcare organizations for a healthier world.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col d-flex justify-content-center card-col-view">
                    <a href="ngoListing.php?category=Food Bank">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                <h6>Food Bank</h6>
                                <p class="card-text">Feeding Hope. Join the fight against hunger with food banks.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col d-flex justify-content-center card-col-view">
                    <a href="ngoListing.php?category=Seniors Welfare">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                <h6>Seniors Care</h6>
                                <p class="card-text">Caring for Our Elders. Support senior care organizations providing love and assistance.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col d-flex justify-content-center card-col-view" >
                    <a href="ngoListing.php?category=Mental Health">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                <h6>Mental Health</h6>
                                <p class="card-text">Nurturing Minds. Backing mental health NGOs for stronger well-being.</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="ngoListing.php?category=Environment Care">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Preserving Our Planet. Backing environmental NGOs for a greener future.</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="ngoListing.php?category=Differently Abled">
                        <div class="card" style="width: 18rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Empowering Abilities. Supporting NGOs for differently-abled individuals.</p>
                            </div>
                        </div>
                    </a>
                </div>
