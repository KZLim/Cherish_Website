<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../users/user_css/register.css">
    </head>
    ...
    <body>
        <div class="register-container" style="justify-content: center; width: 500px; height: 700px;">
            ...
            <form action="../cherish_api/ngo/api_reset_password.php" method="POST" enctype="multipart/form-data" style="padding: 0; width: 95%;">
                ...
                <div class="d-flex justify-content-end">
                    <input class="btn btn-primary btn-reg-signin" id="resetPasswordBtn" type="submit" value="Reset">
                </div>
            </form>
        </div>
    </body>
