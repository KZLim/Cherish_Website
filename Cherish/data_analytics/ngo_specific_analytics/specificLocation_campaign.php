...
<html>
<head>
    <title>Donors Location | Specific</title>
...
<body>
        ...
        <div class="row">
            <div class="col">
                <div style="width: 400px; height: 400px;">
                    <canvas id="specificLocation_campaign"></canvas>
                </div>
            </div>
            <div class="col d-flex flex-column justify-content-center align-items-center">
                <h4>This Campaign Donor's Location</h4>
                <table class="table">
                    <thead>
                        <tr>
    ...
    <script>
        ...
        var ngoSpecificLocation_campaign = document.getElementById('specificLocation_campaign').getContext('2d');

        var locationGroupSpecific_campaign = {
        ...
        var locationGroupDataSpecific_campaign= {
            ...
            datasets: [{
                data: [locationGroupSpecific_campaign["Perlis"],locationGroupSpecific_campaign["Kedah"],locationGroupSpecific_campaign["Pulau Pinang"],locationGroupSpecific_campaign["Perak"],
                        locationGroupSpecific_campaign["Kelantan"],locationGroupSpecific_campaign["Terengganu"],locationGroupSpecific_campaign["Pahang"], locationGroupSpecific_campaign["Kuala Lumpur"],
                        locationGroupSpecific_campaign["PutraJaya"],locationGroupSpecific_campaign["Selangor"],locationGroupSpecific_campaign["Negeri Sembilan"],locationGroupSpecific_campaign["Melaka"],
                        locationGroupSpecific_campaign["Johor"],locationGroupSpecific_campaign["Sarawak"],locationGroupSpecific_campaign["Sabah"],locationGroupSpecific_campaign["Labuan"]], // Values for each slice
        ...
        // Create a pie chart
        var specificLocation_campaign = new Chart(ngoSpecificLocation_campaign, {
            type: 'pie',
            data: locationGroupDataSpecific_campaign
        });
    </script>
</body>
</html>
