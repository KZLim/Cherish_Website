<html>
    ...
    <body>
        <?php
            ...
            $query = mysqli_query($dbc,"SELECT ngo_name, profile_path, banner_path FROM ngo_profile WHERE `ouid`= '".$_SESSION["identifier"]."'");
            ...
            <div class="tab-content" style="overflow: auto; height: 600px;" >
                <div class="tab-pane fade show active" id="ngoDetails">
                    ...
                    $query2 = mysqli_query($dbc,"SELECT * FROM ngo_profile WHERE `ouid`= '".$_SESSION["identifier"]."'");
                ...
                <br/>
                    ...
                    <button id="jumpActive" class="btn btn-primary"><a href="#activeSection" style="color: white;">Active</a></button>
                    <button id="jumpPast" class="btn btn-primary"><a href="#pastSection" style="color: white;">Past</a></button>
                    ...
                    echo'<div class="container-fluid">';
                        ...
                        $query3 = mysqli_query($dbc,"SELECT * FROM ngo_campaign WHERE `ouid`= '".$_SESSION["identifier"]."' AND closing_date > '".$currentDate."'");
                    ...
                    echo'<div class="container-fluid">';
                        ...
                        $currentDate = date('Y-m-d');
                        $query4 = mysqli_query($dbc,"SELECT * FROM ngo_campaign WHERE `ouid`= '".$_SESSION["identifier"]."' AND closing_date <= '".$currentDate."'");
                ...
                <div class="tab-pane fade" id="volunteerCampaign">
                    ...
                    <button id="jumpActive" class="btn btn-primary"><a href="#activeActivitySection" style="color: white;">Active</a></button>
                    <button id="jumpPast" class="btn btn-primary"><a href="#pastActivitySection" style="color: white;">Past</a></button>
                    ...
                    echo'<div class="container-fluid">';
                        ...
                        $currentDate = date('Y-m-d');
                        $query5 = mysqli_query($dbc,"SELECT * FROM ngo_activity WHERE `ouid`= '".$_SESSION["identifier"]."' AND closing_date > '".$currentDate."'");
                    ...
                    echo'<div class="container-fluid">';
                        ...
                        $currentDate = date('Y-m-d');
                        $query6 = mysqli_query($dbc,"SELECT * FROM ngo_activity WHERE `ouid`= '".$_SESSION["identifier"]."' AND closing_date <= '".$currentDate."'");
