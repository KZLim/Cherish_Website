<html>
    ...
    <body>
        <?php
            ...
            $query = mysqli_query($dbc,"SELECT ngo_activity.activity_name, ngo_activity.activity_banner, ngo_profile.ngo_name FROM ngo_activity INNER JOIN ngo_profile ON ngo_profile.ouid = ngo_activity.ouid WHERE ngo_activity.activity_id = '$targetActivity'");
            ...
            echo'<div class="container-fluid">';
                ...
                $query2 = mysqli_query($dbc,"SELECT * FROM ngo_activity WHERE activity_id = '$targetActivity'"); 
                        ...
                        <div class="col md-6 d-flex justify-content-center" style="border: 0px solid black; padding: 0px;">
                            <div class="card" style="width: 95%; height: auto; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">';
                                echo'<div class="card-body">
                                        ...
                                        if(!empty($_SESSION['identifier'])){
                                            if($progress<$participationLimit && substr($_SESSION['identifier'],0,3)!="crt" && $canParticipate==false){
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="volunteerForm" action="../cherish_api/ngo/api_participate_activity.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="campaignIdParam" value='.$targetActivity.'>

                                </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary btn-reg-signin" data-bs-dismiss="modal">Close</button>
                                <input class="btn btn-secondary btn-reg-signin" id="participateVolunteerBtn" type="submit" value="Volunteer" form="volunteerForm">
                            </div>
                        </div>
                    </div>
                </div>';
            ...
            echo'<div class="tab-content" id="myTabContent">';
                echo'<div class="tab-pane fade show active" id="activityDetails" role="tabpanel" aria-labelledby="home-tab" tabindex="0">';
                    ...
                    $query3 = mysqli_query($dbc,"SELECT * FROM ngo_activity WHERE activity_id = '$targetActivity'");
                    ...
                    $query4 = mysqli_query($dbc,"SELECT ngo_profile.ngo_email, ngo_profile.ouid, ngo_profile.ngo_name, ngo_profile.address_line, ngo_profile.city, ngo_profile.state, ngo_profile.postal_code,
                    ngo_profile.ngo_category FROM ngo_profile INNER JOIN ngo_activity ON ngo_profile.ouid = ngo_activity.ouid WHERE ngo_activity.activity_id = '$targetActivity'"); 
                ...
                echo'<div class="tab-pane fade" id="volunteerList" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">';
                    echo'<br/>';
                    $query5 = mysqli_query($dbc,"SELECT user_account.name, user_account.email_address, user_account.ic_number, user_account.address_line,
                    ...
                    FROM user_account INNER JOIN participants_record ON user_account.uid = participants_record.participant_uid WHERE participants_record.activity_id = '$targetActivity'");
