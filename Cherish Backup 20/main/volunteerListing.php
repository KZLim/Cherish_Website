    ...
    <body>
        <?php
            include '../main/header.php';
                ...
                $query = mysqli_query($dbc, "SELECT COUNT(activity_id) as totalCount FROM ngo_activity");
                ...
                $query2 = mysqli_query($dbc, "SELECT * FROM ngo_activity WHERE closing_date > '".$currentDate."' LIMIT $offsetValue, $recordsPerPage");
