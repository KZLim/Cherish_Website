        ...
        <?php
                            ...
                            <div class="card" style="width: 95%; height: auto; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">';
                                echo'<div class="card-body">
                                        ...
                                        if(!empty($_SESSION['identifier'])){
                                            if($progress<$raiseGoal && substr($_SESSION['identifier'],0,3)!="crt" && !empty($_SESSION['identifier']) ){
            ...
            echo'<div class="tab-content" id="myTabContent">';
                ...
                echo'<div class="tab-pane fade" id="donorList" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">';
                    ...
                    FROM user_account INNER JOIN donors_record ON user_account.uid = donors_record.donor_uid WHERE donors_record.campaign_id = '$targetCampaign'");
